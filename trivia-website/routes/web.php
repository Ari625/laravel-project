...
use App\Http\Controllers\KuisController1;
...
Route::post('/correct',[NextController::class, 'answers'])->middleware('auth');

Route::get('/kuis/finish', [KuisController::class, 'finish'])->middleware('auth');

Route::get('/correct',[NextController::class, 'correct'])->middleware('auth');

Route::get('/wrong',[NextController::class, 'wrong'])->middleware('auth');

Route::get('/kuis/correct',[NextController::class, 'correct'])->middleware('auth');
