<ul class="nav nav-pills nav-fill gap-2 p-1 small bg-primary shadow-sm" id="pillNav2" role="tablist" style="--bs-nav-link-color: var(--bs-white); --bs-nav-pills-link-active-color: var(--bs-primary); --bs-nav-pills-link-active-bg: var(--bs-white);">
   ...
   <button class="shadow-sm rounded-2 mb-3 mt-2" style="color: blue; border : white;">
      <font class="font-bold --bs-primary text-uppercase fw-bolder" size="6px">KUISIS</font>
   </button>
   </li>
   <li class="nav-item" role="presentation">
      <a href="/" class="mt-2 mb-3 btn btn-primary" role="button">
         <font size="4px" class="text-uppercase">Home</font>
      </a>
   </li>
   <li class="nav-item" role="presentation">
      <a href="/leaderboard" role="button" class="btn btn-primary mt-2 mb-3">
         <font size="4px" class="text-uppercase">Leaderboard</font>
      </a>
   </li>
   <li class="nav-item" role="presentation">
      <a href="/profile" class="btn btn-primary mt-2 mb-3" role="button">
