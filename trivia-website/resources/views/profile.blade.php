   ...
   <div class="card mt-5 position-absolute top-50 start-50 translate-middle-x border border-0" style="width: 60rem;"> 
      <div class="card-header rounded-2 mb-2 mt-3 border border-light-subtle">
         <font class="mt-3 mb-2" size="4"> 
            <i class="bi bi-person"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person mb-2 mt-2" viewBox="0 0 16 16">
      ...
      <div class="card-footer rounded-2 mb-2 mt-3 border border-light-subtle">
         <a href="/settings" class="btn">
            <i class="bi bi-gear mb-2 mt-2 mb-2 mt-2"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear mb-2 mt-2" viewBox="0 0 16 16">
      ...
      <div class="card-footer rounded-2 mb-2 mt-3 border border-light-subtle">
         <form action="/logout" method="post">
            ...
            <button type="submit" class="btn">
               <i class="bi bi-box-arrow-right mb-2 mt-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" 
                  class="bi bi-box-arrow-right mb-2 mt-2" viewBox="0 0 16 16">
